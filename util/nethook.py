"""
This file is based on https://github.com/kmeng01/memit/blob/main/util/nethook.py
...
class Trace(contextlib.AbstractContextManager):
    ...
    def __init__(
        ...
        Adapted to be able to deal with StableDiffusionPipeline.
        Args:
            module: the module to instrument.
            layer: the name of the layer to instrument, or the module itself.
            retain_output: whether to retain the output of the layer.
            retain_input: whether to retain the input of the layer.
            clone: whether to clone the output (or input) of the layer.
            detach: whether to detach the output (or input) of the layer.
            retain_grad: whether to retain the gradient of the output.
            edit_output: a function to modify the output of the layer.
            stop: whether to stop execution after the layer.
        """
        retainer = self
        self.layer = layer
        if layer is not None:
            if isinstance(module, StableDiffusionPipeline):
                # specify unet or text_encoder from layer name
